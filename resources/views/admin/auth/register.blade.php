...
@section('content')
    ...
    <div class="my-7 flex-col items-center text-sm text-black sm:flex">
        <div class="mx-auto flex max-w-md flex-col p-7 sm:border sm:shadow-md">
            <h1 class="py-3 text-center text-3xl">Register</h1>
            <p class="pb-3 text-center">to continue to <strong class="text-black">Telco Admin Dashboard</strong></p>
            <form action="{{ url('/register') }}" method="post">
                ...
                <div class="flex flex-col py-2">
                    ...
                    <div class="relative flex items-center">
                        <input
                            class="z-10 w-full border-0 border-b-2 border-gray-200 bg-transparent text-sm focus:border focus:border-b-2 focus:ring-0"
                ...
                <p class="pt-4 text-center">Already have an account? <a class="font-bold" href="login">Log In</a></p>
            </form>
        </div>
    </div>
