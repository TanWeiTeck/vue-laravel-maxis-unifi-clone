<h1 id="fibreplan" class="py-4 text-center text-3xl font-extrabold text-blue-900">
...
<div class="flex max-h-max snap-x snap-mandatory overflow-x-auto md:flex-wrap md:justify-center">
    @foreach ($TelcoPackages as $package)
        <div
            class="my-4 mx-3 min-h-[370px] min-w-[20rem] snap-center overflow-hidden rounded-2xl border-2 border-blue-800 bg-white shadow-md duration-500 hover:border-blue-500 hover:shadow-lg hover:shadow-blue-400 sm:max-w-[20rem] lg:max-w-[24rem]">
            ...
            <div class="bg-white px-5 py-3 text-gray-900">
                <h1 class="font-b text-xl">Recommended For</h1>
                <ul class="">
                    <li class=""><span class="text-xl font-extrabold text-blue-800">&#9737;</span>
                        {{ $package['description'] }}</li>
                </ul>
                <p class="text-[0.6rem]">* Existing customer who change rate plan is not eligible for free DECT phone.
                </p>
