...
<div class="p-3">
    ...
    {{-- service section a --}}
    <div class="flex flex-wrap justify-center md:space-x-7 lg:space-x-14">
        {{-- service card a1 --}}
        <div class="flex max-w-md flex-col items-center space-y-3 py-3 lg:max-w-sm">
    ...
    <div class="bg-gray-200 p-3">
        ...
        <!-- service cards b -->
        <div class="m-auto flex flex-wrap justify-center sm:space-x-4 lg:space-x-10">
            <!-- service card b1 -->
